        ...
        {thread ? (
          ...
          <div className="flex p-4 justify-center">
            <button
              ...
              className="flex items-center justify-center bg-green-600 text-white rounded-full px-4 py-2 hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-800"
